...
<body>
	...
	<br/>
	<h1 style="color: white;" align="center">Admin Login Form!</h1>
	<hr>
	<br/>
	<h3 style="color: red;" align="center">Username or password you have entered is not correct.</h3>
	<form action="logadmin" name="frm" method="post" onsubmit="return validate();">
